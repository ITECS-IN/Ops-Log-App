...
export default function Login() {
  useEffect(() => {
    document.title = "Login | Shift Log";
  }, []);
  ...
  <div className="flex flex-col items-center justify-center min-h-screen bg-linear-to-br from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800">
      <form
        ...
        className="bg-white/90 dark:bg-gray-900/90 p-8 rounded-xl shadow-xl w-full max-w-sm space-y-5 border border-gray-100 dark:border-gray-800 animate-fade-in"
      >
  <AppLogo size={64} className="mx-auto! mb-2!" />
        <h2 className="text-3xl font-extrabold mb-2 text-center text-primary tracking-tight">Sign in to Shift Log</h2>
        <p className="text-center text-muted-foreground mb-2 text-sm">Enter your credentials to continue</p>
