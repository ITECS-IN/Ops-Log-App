...
export default function Login() {
  ...
  <div className="flex flex-col items-center justify-center min-h-screen bg-linear-to-br from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 px-4 sm:px-6">
      ...
      >
        ...
        <h2 className="text-2xl sm:text-3xl font-extrabold mb-2 text-center text-primary tracking-tight">Sign in to Shift Log</h2>
        <p className="text-center text-muted-foreground mb-2 text-xs sm:text-sm">Enter your credentials to continue</p>
